...
public class OrderMapperImpl implements OrderMapper {
    ...
    public Order convertDtoToEntity(OrderResponseDto d) {
        ...
        if ( d.dateTimeOrder() != null ) {
            order.dateTimeOrder( LocalDateTime.parse( d.dateTimeOrder() ) );
        }
    ...
    public OrderResponseDto convertEntityToDto(Order order) {
        ...
        if ( order.getDateTimeOrder() != null ) {
            dateTimeOrder = DateTimeFormatter.ISO_LOCAL_DATE_TIME.format( order.getDateTimeOrder() );
        }
